  ...
  return (
    <>
      <div className="h-[80vh] flex justify-center items-center flex-col space-y-3 p-2 ">
        ...
        <div
          className={`flex flex-col justify-center items-center space-y-2 max-w-[450px] p-3  h-auto md:h-[200px] w-full border-1 rounded-md shadow-lg ${
            darkMode ? "border-[1px]" : "shadow-[rgb(225,225,225)]"
          }`}
        >
          <div>
